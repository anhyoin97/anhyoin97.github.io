...
- **정보 및 AI윤리**
    - AI 윤리 가이드라인
      - [AI 윤리 가이드라인](https://anhyoin97.github.io/posts/AI-ethics/)
    - 데이터 윤리 / 책임 있는 AI
- **IT 감리**
    - 감리 절차 / 감리원 역할
...
- **자료구조론**
    - 기본 알고리즘 효율성 분석
      - [기본 알고리즘 효율성 분석](https://anhyoin97.github.io/posts/DataStructure-Algorithm/)
- **데이터모델링**
    - 정규화/반정규화
      - [정규화/반정규화](https://anhyoin97.github.io/posts/Normalization-Denormalization/)
    - ERD 설계
- **DBMS 및 분산처리**
    - 분산 DB, 샤딩, 레플리케이션
    - CAP 이론
